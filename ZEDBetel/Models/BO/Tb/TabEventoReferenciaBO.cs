...
/// </summary>
public class TabEventoReferenciaBO
{
    ...
    public DataSet FindAll()
    {
        try
        {
            ...
            strSql.Append(" FROM  TabEventoReferencia  ");

            objDO = new DO();

            // executa consulta e retorna um DataSet
            return objDO.GetDataSet(strSql.ToString(), "TabEventoReferencia");
        }
        catch (Exception er)
        {
    ...
    /// <returns>int</returns>
    public int Insert(TabEventoReferenciaVO _vo)
    {
        try
        {
            strSql = new StringBuilder();
            strSql.Append(" INSERT INTO  TabEventoReferencia  ");
            strSql.Append(" (");
    ...
    /// <param name="_vo">objetos vo do banco</param>
    /// <returns>int</returns>
    public int Update(TabEventoReferenciaVO _vo)
    {
        try
        {
            strSql = new StringBuilder();
            strSql.Append(" UPDATE  TabEventoReferencia  ");
            strSql.Append(" SET ");
    ...
    /// <param name="_vo">objetos vo do banco</param>
    /// <returns>int</returns>
    public int Delete(TabEventoReferenciaVO _vo)
    {
        try
        {
            strSql = new StringBuilder();
            strSql.Append(" DELETE FROM TabEventoReferencia  ");
            strSql.Append(" WHERE ( Codigo = " + _vo.Codigo + " ) ");
