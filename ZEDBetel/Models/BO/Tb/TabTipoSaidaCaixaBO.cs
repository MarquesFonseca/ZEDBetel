...
/// </summary>
public class TabTipoSaidaCaixaBO
{
    ...
    public DataSet FindAll()
    {
        try
        {
            ...
            strSql.Append(" FROM  TabTipoSaidaCaixa  ");

            objDO = new DO();

            // executa consulta e retorna um DataSet
            return objDO.GetDataSet(strSql.ToString(), "TabTipoSaidaCaixa");
        }
        catch (Exception er)
        {
    ...
    /// <returns>int</returns>
    public int Insert(TabTipoSaidaCaixaVO _vo)
    {
        try
        {
            strSql = new StringBuilder();
            strSql.Append(" INSERT INTO  TabTipoSaidaCaixa  ");
            strSql.Append(" (");
    ...
    /// <param name="_vo">objetos vo do banco</param>
    /// <returns>int</returns>
    public int Update(TabTipoSaidaCaixaVO _vo)
    {
        try
        {
            strSql = new StringBuilder();
            strSql.Append(" UPDATE  TabTipoSaidaCaixa  ");
            strSql.Append(" SET ");
    ...
    /// <param name="_vo">objetos vo do banco</param>
    /// <returns>int</returns>
    public int Delete(TabTipoSaidaCaixaVO _vo)
    {
        try
        {
            strSql = new StringBuilder();
            strSql.Append(" DELETE FROM TabTipoSaidaCaixa  ");
            strSql.Append(" WHERE ( Codigo = " + _vo.Codigo + " ) ");
